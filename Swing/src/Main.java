...
public class Main extends JPanel
{
    ...
    public Main()
    {
        ...
        buttons2[0] = new JButton("Yes");
        buttons2[1] = new JButton("NO");
        jpanel2.add(buttons2[0]);
        jpanel2.add(buttons2[1]);
...
//        jFrame.getContentPane().add(new Main());
    ...
    public void initializebuttons()
    {
        for(int i = 0; i <= 8; i++)
        {
            ...
            jpanel.add(buttons[i]); //adds this button to JPanel (note: no need for JPanel.add(...)
